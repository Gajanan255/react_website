        ...
        <div>
                ...
                <div style={{ paddingLeft: "22px" }}>
                    ...
                    <div className='first'>
                        <div className='first-1'>
                            ...
                            <h1 style={{color:"white",fontSize:"97px",fontFamily:"serif",fontWeight:"111"}}>Gajanan Jena</h1>
                            ...
                            <a href='https://drive.google.com/file/d/1N71ao-ZsAQhHCLth6i-IZbx_wc0mqK0O/view?usp=drivesdk' className='btn'>Download CV</a>
            ...
            <div className='six'>
                <div className='six-1'>
                    ...
                    <br /> <a href='https://drive.google.com/file/d/1N71ao-ZsAQhHCLth6i-IZbx_wc0mqK0O/view?usp=drivesdk' className='button'><h2>Download CV</h2></a>
                </div>
                <div className='six-2'>
                    <label>Name: </label><br />
                    <input type="text" placeholder='Enter your Name' style={{ width: "320px", height: "28px", fontSize: "20px", fontFamily: "serif"}} /><br /><br />
                    <label>Email: </label><br />
                    <input type="number" placeholder='Enter your Mail' style={{ width: "320px", height: "28px", fontSize: "20px", fontFamily: "serif" }} /><br /><br />
