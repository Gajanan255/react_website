        ...
        <div>
                ...
                <div style={{ paddingLeft: "22px" }}>
                    ...
                    <div className='first'>
                        <div className='first-1'>
                            <span style={{ color: "lime", fontSize: "27px" }}>Hellow, My name is</span><br />
            ...
            <div className='second'>
                ...
                <div className='second-2'>
                    ...
                    <p style={{ color: "black", marginLeft: "20px", fontSize: "20px", textAlign: "justify", textIndent: "22px" }}>I'm a Frontend Developer and a self-motivated IT professional with huge knowledge and proficiency in web development, as well as strong skills and ability in writing clean and efficient code with proper Indentation.</p>
                    <br />
                    <p style={{ color: "black", marginLeft: "20px", fontSize: "20px", textAlign: "justify" }}>I am Completed my Matriculation on 2017 from Saraswati sishu vidya Mandir School. Completed my +2 on 2019 from Kabisurya Baladev Vigyan Mahavidyalaya. Completed my Under graduation(BCA) On sep - 2022 from Disha College of Management and Technology.</p>
                    <br />
                    <div style={{ display: "flex", width: "230px", marginLeft: "42px" }}>
                        <a href='tel:+918118099250'><img src={call} className='pngsizeeeee' /></a><h3 style={{ color: "black", width: "160px", marginTop: "11px" }}><a href='tel:+918118099250' className='loo'>+918118099250</a></h3>
                    </div>
                </div>
            </div>{/* complite second */}
            ...
            <div className='third'>
                ...
                <div className='third-1'>
                    ...
                    <progress max="100" value="95" style={{ width: "410px" }}>95</progress><br />

                    <img src={c} className='one' /> CSS<h3 className='per'>77%</h3>
                    <progress max="100" value="77" style={{ width: "410px" }}>77</progress><br />

                    <img src={j} className='one' /> JavaScript<h3 className='per'>75%</h3>
                    <progress max="100" value="75" style={{ width: "410px" }}>75</progress><br />

                    <img src={oop} className='one' /> JavaScript Oops<h3 className='per'>70%</h3>
                    <progress max="100" value="70" style={{ width: "410px" }}>70</progress><br />

                    <img src={r} className='one' /> React JS<h3 className='per'>85%</h3>
                    <progress max="100" value="85" style={{ width: "410px" }}>95</progress><br />

                    <img src={tool} className='one' /> Redux Toolkit<h3 className='per'>65%</h3>
                    <progress max="100" value="65" style={{ width: "410px" }}>65</progress><br />
                </div>
                <div className='third-2'>
                    <h3 style={{ color: "black", fontFamily: "serif", fontSize: "25px" }}>My creative skills and experience..</h3><br />
                    <p style={{ color: "black", fontFamily: "serif", fontSize: "20px", paddingLeft: "22px", wordSpacing: "8px", textAlign: "justify", textIndent: "22px" }}>The answer to "what is a web developer?" is complex , and is easier to answer by looking at their daily responsibilities. They need to work with different departments and even different clients to create a blueprint and execute a website through completion. Once the website is built, they need to continue maintaining it with the addition of new content and continue fixing bugs, errors, and other problems as they arise.</p>
            ...
            <div className='four'>
                <div className='four-1'>
                    ...
                    <br />
                    <p style={{ paddingLeft: "10px", paddingRight: "10px", fontSize: "20px", fontFamily: "serif", textAlign: "justify", textIndent: "22px" }}>Designing a website involves the process of deeplyplanning, ideating and executing a plan to create an user friendly platform. and we do it professionally.</p>
                </div>
                <div className='four-2'>
                    <h3 style={{ marginLeft: '7px' }}>UI / UX</h3><img src={uiux} className='fourpng' /><br />
                    <p style={{ paddingLeft: "10px", paddingRight: "10px", fontSize: "20px", fontFamily: "serif", textAlign: "justify", textIndent: "22px" }}>A UI/UX designer is someone who has expertise in crafting the user interface (UI) and user experience (UX) of products, like websites, mobile apps and software.</p>
                </div>
                <div className='four-3'>
                    <h3 style={{ marginLeft: '7px' }}>Different Layout</h3><img src={pic} className='fourpng' /><br />
                    <p style={{ paddingLeft: "10px", paddingRight: "10px", fontSize: "20px", fontFamily: "serif", textAlign: "justify", textIndent: "22px" }}>Designing a website or application to be responsive across various devices like laptops, mobile phones, and tablets is a crucial aspect of modern web development. Here's an overview of how different layouts. </p>
                </div>
            </div>
            {/* complite fourr */}
            <br />
            ...
            <div className='six'>
                <div className='six-1'>
                    ...
                    <img src={call} className='pngsize' /> <a href="tel:+918118099250" style={{ color: "white" }}>+918118099250</a><br />
