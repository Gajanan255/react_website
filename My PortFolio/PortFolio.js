        ...
        <div>
                ...
                <div style={{ paddingLeft: "22px" }}>
                    ...
                    <div className='first'>
                        <div className='first-1'>
                            ...
                            <a href='https://drive.google.com/file/d/1O1RRTPZrpaClvSNJF95hAdecZbv8qoB3/view?usp=drivesdk' className='btn'>Download CV</a>
            ...
            <div className='six'>
                <div className='six-1'>
                    ...
                    <br /> <a href='https://drive.google.com/file/d/1O1RRTPZrpaClvSNJF95hAdecZbv8qoB3/view?usp=drivesdk' className='button'><h2>Download CV</h2></a>
                </div>
                <div className='six-2'>
                    <label>Name: </label><br />
