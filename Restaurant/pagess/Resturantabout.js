    ...
    <div>
      <div style={{ backgroundImage: "url('https://c0.wallpaperflare.com/preview/735/804/924/red-apple-fruit-on-dark-background-with-water-drops.jpg')", width: "100%", height: "100%", backgroundRepeat: "no-repeat", backgroundSize: "cover", color: "white" }}>
        ...
        <div style={{ margin: "20px" }}>
          <h2 style={{fontSize:"30px"}}>What is a shopping cart?</h2><br />
          <p style={{fontSize:"20px"}}>Definition: A shopping cart on an online retailer's site is a piece of software that facilitates the purchase of a product or service. It accepts the customer's payment and organizes the distribution of that information to the merchant, payment processor and other parties.
          </p><br/>
          <h2 style={{fontSize:"30px"}}>Why shopping carts are important?</h2><br />
          <p style={{fontSize:"20px"}}>Shopping carts bridge the gap between shopping and buying, so having the best shopping cart software is extremely important on your website.
          ...
          <h2 style={{fontSize:"30px"}}>What options are there?</h2>
          <p style={{fontSize:"20px"}}>For those seriously considering the ecommerce platform route, it's important to know that there are two basic types of carts:
