...
function Home() {
  return (
    <div>
      <div style={{ backgroundImage: "url('https://c1.wallpaperflare.com/preview/939/168/870/596c982930fc7.jpg')", width: "100%", height: "625px", backgroundRepeat: "no-repeat", backgroundSize: "cover", color: "white" }}>
        <nav>
